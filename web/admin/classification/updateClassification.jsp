    ...
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            <img border="0" width="13" height="13"
                 src="${pageContext.request.contextPath }/admin/public/style/images/title_arrow.gif"/> 更新分类
        </div>
    </div>
...
<div id="MainArea">
    <!-- 表单内容 -->
    <form action="${pageContext.request.contextPath }/ClassificationServlet?method=update" method="post">
                ...
                <div class="ItemBlock2">
                    <table cellpadding="0" cellspacing="0" class="mainForm">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="classificationName" class="InputStyle"
                                       value="${requestScope.classification.classificationName }"/> *
                                <input type="hidden" name="classificationId" value="${requestScope.classification.classificationID }"/>
                            </td>
                        </tr>
                    </table>
                </div>
