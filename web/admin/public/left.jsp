...
#Menu .level1 .level1Style {
  background: url("${pageContext.request.contextPath }/admin/public/style/images/menu_btn_bg.gif") no-repeat scroll 0 0 transparent;
    height: 23px;
    padding-left: 20px;
    padding-top: 5px;
    width: 135px;
...
#Menu .level1 .MenuLevel2 .level2Style{
	...
	padding-top: 5px;
	width: 112px;
	background-image:url(${pageContext.request.contextPath }/admin/public/style/images/menu_arrow_single.gif);
    ...
    <ul id="Menu">
	    <li class="level1">
            <div onClick="menuClick(this);" class="level1Style">
				<img src="${pageContext.request.contextPath }/admin/public/style/images/func20001.gif" class="Icon" />
				系统菜单
			</div>
            <ul class="MenuLevel2">
